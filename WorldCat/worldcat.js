...
var page=1,total_links=1000000,j=1,total_records,i=0,n=10,arrayList;
//var number,recording,artist,publisher;
var recording =[];
var artist=[];
var publisher=[];
var source_link=[];
	    ...
	    if (err) {
		  ...
		  $ = cheerio.load(res.body);
			...
			if(page == 1)
			{
				...
				while(k<10)
				{
						obj.table.push({recording_number: page+k,recording: recording[k], artist:artist[k], publisher:publisher[k], source:source_link[k]});
						k = k + 1;
				}
